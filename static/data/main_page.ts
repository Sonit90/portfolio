...
export const mainPage: ContentWrapper[] = [
      { 
        ...
        "content": [
          {
            "type": "text",
            "content": "I'm a passionate Vue.js developer with over 5 years of experience in web development. I’ve had the privilege of building software for an "
          },
          {
            "type": "link",
      ...
      },
      {
        ...
        "content":[
            {
                "type":"text",
                "content": "When I'm away from computed, I usually hang out with my friends, play board games or go to some meetings"
            }
        ]
      },
      {
        ...
        "content":[
            {
                "type":"text",
                "content": "Feel free to explore my portfolio and reach out for potential collaborations. Let's create something incredible together!"
            }
        ]
      }
    ]
